...
export const RERA_AUTHORITIES: Record<string, ReraAuthorityInfo> = {
  maharashtra: {
    ...
    numberPatternDescription: "Begins with P5 followed by district and registration digits (e.g. P518000XXXXX, P520000XXXXX)",
  },
  haryana: {
    state: "Haryana",
    code: "HR",
  ...
  "uttar pradesh": {
    ...
    numberPatternDescription: "Begins with UPRERAPRJ followed by project number (e.g. UPRERAPRJXXXXX)",
  },
  delhi: {
    state: "Delhi",
    code: "DL",
    ...
    numberPatternDescription: "Begins with DLRERA followed by registration code (e.g. DLRERAXXXXX)",
  },
  gujarat: {
    state: "Gujarat",
    code: "GJ",
  ...
  telangana: {
    ...
    numberPatternDescription: "Begins with P0 followed by registration digits (e.g. P024000XXXXX)",
  },
  "tamil nadu": {
    state: "Tamil Nadu",
    code: "TN",
  ...
  "madhya pradesh": {
    ...
    numberPatternDescription: "Begins with P- followed by district and registration number (e.g. P-BPL-XX-XXXX)",
  },
  goa: {
    state: "Goa",
    code: "GA",
  ...
  "andhra pradesh": {
    ...
    code: "AP",
    authorityName: "Andhra Pradesh Real Estate Regulatory Authority",
    shortName: "AP RERA",
    officialPortal: "https://rera.ap.gov.in",
    projectSearchUrl: "https://rera.ap.gov.in",
    complaintUrl: "https://rera.ap.gov.in",
    numberPatternDescription: "Begins with P0 followed by district and registration sequence (e.g. P032900XXXXX)",
  },
  kerala: {
    state: "Kerala",
    code: "KL",
    authorityName: "Kerala Real Estate Regulatory Authority",
    shortName: "K-RERA",
    officialPortal: "https://rera.kerala.gov.in",
    projectSearchUrl: "https://rera.kerala.gov.in",
    complaintUrl: "https://rera.kerala.gov.in",
    numberPatternDescription: "Begins with K-RERA/PRJ/ followed by sequence (e.g. K-RERA/PRJ/XXX/XXXX)",
  },
  punjab: {
    state: "Punjab",
    code: "PB",
    authorityName: "Punjab Real Estate Regulatory Authority",
    shortName: "Punjab RERA",
    officialPortal: "https://rera.punjab.gov.in",
    projectSearchUrl: "https://rera.punjab.gov.in",
    complaintUrl: "https://rera.punjab.gov.in",
    numberPatternDescription: "Begins with PBRERA- followed by district and project sequence (e.g. PBRERA-SAS80-PRXXXX)",
  },
};
