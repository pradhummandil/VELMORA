...
const review_data: DataType[] = [
   {
      ...
      desc: (<>VELMORA guided us to an exceptional residence on Golf Course Road. Their advisory depth and attention to architectural details made every step effortless.</>),
   },
   {
      id: 2,
      ...
      desc: (<>Finding our private villa in Assagao was made completely transparent. The legal due diligence and local advisory were exemplary.</>),
   },
   {
      id: 3,
      ...
      rating: ["star", "star", "star", "star", "star"],
      desc: (<>The private advisory desk in Worli handled our residence acquisition with the utmost discretion and efficiency. A benchmark in Indian luxury real estate.</>),
   },
   {
      id: 4,
      img: agencyDetailsImg_1,
      ...
      total_rating: "(4.9 Rating)",
      rating: ["star", "star", "star", "star", "star"],
      desc: (<>Outstanding experience acquiring our sky residence in Indiranagar. The team demonstrated profound market knowledge and integrity throughout the entire process.</>),
   },
]
const UserReview = () => {
