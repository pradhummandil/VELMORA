...
const feedback_data: DataType[] = [
   {
      ...
      desc: "Efficient, knowledgeable, & made our home search a smooth experience. Highly recommended advisory!",
      rating_count: 4.9,
      total_rating: 14,
   },
   {
      ...
      desc: "Efficient, knowledgeable, & made our luxury villa acquisition seamless and transparent!",
      rating_count: 4.8,
      total_rating: 12,
   },
   {
      ...
      desc: "The advisory team guided us perfectly to our high-rise penthouse with complete peace of mind!",
      rating_count: 5.0,
      total_rating: 16,
   },
]
