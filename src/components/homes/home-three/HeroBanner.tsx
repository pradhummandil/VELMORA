         ...
         <div className="container position-relative z-2">
            <div className="row">
               <div className="col-lg-10 m-auto">
                  ...
                  <p className="fs-24 text-white text-center pt-35 md-pt-20 pb-55 lg-pb-40 wow fadeInUp" data-wow-delay="0.1s">Discover curated residences and luxury properties across India.</p>
               </div>
            </div>
				<div className="row">
