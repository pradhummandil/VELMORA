         ...
         <div className="container container-large">
            <div className="row">
               ...
               <div className="col-xxl-6 col-lg-7 ms-auto">
                  <p className="fs-24 lh-lg mb-30 color-dark">Your trusted real estate partner, transforming spaces into exceptional homes. Curated properties and personalised guidance for buy, rent & investment.</p>
