                  ...
                  <div className="ps-xxl-5">
                     ...
                     {sortedProperties.length === 0 ? (
                        <div className="text-center py-5 bg-white rounded-4 shadow-sm border p-4 mb-40">
                           ...
                           <h4 className="mb-2">No residences found{searchParams.get("location") ? ` for "${searchParams.get("location")}"` : ""}</h4>
                           ...
                           <button onClick={handleResetFilter} className="btn-two">Reset Search</button>
                        </div>
                     ) : (
                        <>
