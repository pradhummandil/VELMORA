...
const ListingFourArea = ({ style }: any) => {
   ...
   return (
      <div className="property-listing-eight pt-150 xl-pt-120 pb-150 xl-pb-120">
         ...
         <div className="container">
            <div className="listing-header-filter d-sm-flex justify-content-between align-items-center mb-40 lg-mb-30">
               <div>Showing <span className="color-dark fw-500">{currentItems.length > 0 ? itemOffset + 1 : 0}–{itemOffset + currentItems.length}</span> of <span className="color-dark fw-500">{sortedProperties.length}</span> results</div>
               <div className="d-flex align-items-center xs-mt-20">
                  ...
                  <Link href="/listing_03" className="tran3s layout-change rounded-circle ms-auto ms-sm-3" data-bs-toggle="tooltip" title="Switch To Grid View" aria-label="Switch To Grid View"><i className="fa-regular fa-grid-2"></i></Link>
               </div>
            </div>
                     ...
                     <div className="d-flex flex-wrap layout-one">
                        ...
                        <div className="property-info">
                           ...
                           <div className="pl-footer d-flex flex-wrap align-items-center justify-content-between">
                              ...
                              <Link href="/listing_details_04" className="btn-four rounded-circle" aria-label="View Details"><i className="bi bi-arrow-up-right"></i></Link>
                           </div>
                        </div>
                     </div>
                  </div>
