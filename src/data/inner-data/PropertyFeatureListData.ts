...
const property_feature_list: DataType[] = [
   {
      ...
      feature_list: [
         ...
         { title: "Furnishing:", count: "Fully Furnished" },
         { title: "Bathrooms:", count: "03" },
         { title: "Year Built:", count: "2022" },
         { title: "Floor:", count: "27th (High-Rise)" },
         { title: "Parking:", count: "02 Covered" },
         { title: "Ceiling Height:", count: "3.6m" },
         { title: "Property Type:", count: "Luxury Apartment" },
         { title: "Carpet Area:", count: "2,200 sq.ft" },
         { title: "Status:", count: "Ready to Move" },
      ],
   },
   {
      id: 2,
